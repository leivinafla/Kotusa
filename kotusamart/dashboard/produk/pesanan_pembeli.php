    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link mr-4" href="transaksi.php">DAFTAR MENU</a>
                </li>
                <li class="nav-item">
...
<div class="container">
    ...
    if (isset($_POST['konfirm'])) {
        ...
        $insert = mysqli_query($koneksi, "INSERT INTO detail_pembelian (tanggal_pemesanan, total_belanja) VALUES ('$tanggal_pemesanan', '$totalbelanja')");
        ...
        foreach ($_SESSION["pesanan"] as $id_produk => $jumlah) {
            $insert = mysqli_query($koneksi, "INSERT INTO pembelian (id_pemesanan, id_produk, jumlah) 
